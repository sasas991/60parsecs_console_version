...
public class eventfactory {
    ...
    static {
        events.add(new MeteorEvent());
        events.add(new ContainerEvent());
        events.add(new TraderEvent());
        events.add(new FilterEvent());
        events.add(new SicknessEvent());
        events.add(new ComputerEvent());
        events.add(new LockedRoomEvent());
    }
    ...
    // --- Event Implementations (SRP) ---

    private static class MeteorEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
            ui.println("");
            ui.println("      ");
            ui.println("  ");
    ...
    private static class ContainerEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
            ui.println("");
    ...
    private static class TraderEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
    ...
    private static class FilterEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
    ...
    private static class SicknessEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
            ui.println("");
            ui.println("      .-.");
    ...
    private static class ComputerEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
            ui.println("");
            ui.println("      / \\");
    ...
    private static class LockedRoomEvent implements gameevent {
        @Override
        public void execute(gamestate state, IUserInterface ui) {
